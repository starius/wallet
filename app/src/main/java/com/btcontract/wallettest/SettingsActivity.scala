...
import com.btcontract.wallettest.BuildConfig.{VERSION_CODE, VERSION_NAME}
import com.btcontract.wallettest.Colors._
import com.btcontract.wallettest.R.string._
import com.btcontract.wallettest.sheets.{BaseChoiceBottomSheet, PairingData}
import com.btcontract.wallettest.utils.{LocalBackup, OnListItemClickListener}
